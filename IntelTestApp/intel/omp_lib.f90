...
! </copyright>
      ...
      module omp_lib
        ...
        integer (kind=omp_integer_kind), parameter :: openmp_version    = 201611
        integer (kind=omp_integer_kind), parameter :: kmp_version_major = 5
        integer (kind=omp_integer_kind), parameter :: kmp_version_minor = 0
        integer (kind=omp_integer_kind), parameter :: kmp_version_build = 20221004
        character(*)               kmp_build_date
        parameter( kmp_build_date = '2022-10-05 18:30:49 UTC' )
...
!       *** Extension for target memory support
        integer (kind=omp_allocator_handle_kind), parameter :: omp_target_host_mem_alloc = 100
        integer (kind=omp_allocator_handle_kind), parameter :: omp_target_shared_mem_alloc = 101
        integer (kind=omp_allocator_handle_kind), parameter :: omp_target_device_mem_alloc = 102
...
!       *** Extension for target memory support
        integer (kind=omp_memspace_handle_kind), parameter :: omp_target_host_mem_space = 100
        integer (kind=omp_memspace_handle_kind), parameter :: omp_target_shared_mem_space = 101
        integer (kind=omp_memspace_handle_kind), parameter :: omp_target_device_mem_space = 102
...
!         ***
          ...
          function ompx_target_aligned_alloc(align, size, device) bind(c)
            use, intrinsic :: iso_c_binding, only : c_ptr, c_size_t, c_int
          ...
          function ompx_target_aligned_alloc_device(align, size, device) bind(c)
            use, intrinsic :: iso_c_binding, only : c_ptr, c_size_t, c_int
          ...
          function ompx_target_aligned_alloc_host(align, size, device) bind(c)
            use, intrinsic :: iso_c_binding, only : c_ptr, c_size_t, c_int
          ...
          function ompx_target_aligned_alloc_shared(align, size, device) bind(c)
            use, intrinsic :: iso_c_binding, only : c_ptr, c_size_t, c_int
